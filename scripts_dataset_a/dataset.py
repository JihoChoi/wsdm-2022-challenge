...
class LargeGraphDataset():
    def __new__(cls, dataset_name='A', root="./data/wsdm-2022"):
        if dataset_name in ['a', 'A']:
            dataset = LargeGraphDataA(root="./data/wsdm-2022")
...
class LargeGraphDataA(Dataset):
    ...
    def processed_file_names(self):
        ...
        return [f'dataset_a/large_graph.pt']
        # return [
    ...
    def process(self):
        ...
        with open(f"{self.root}/raw/train/edge_type_features.csv", mode='r') as file:
            ...
            for row in reader:
                ...
                edge_type_feature_dict[int(edge_type)] = features
        ...
        with open(f"{self.root}/raw/train/node_features.csv", mode='r') as file:
            ...
            for row in reader:
                ...
                node_feature_dict[int(node_id)] = features
        ...
        data = Data(
            ...
            edge_type_feature_dict=edge_type_feature_dict,
