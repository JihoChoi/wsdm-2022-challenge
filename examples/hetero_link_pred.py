...
# https://github.com/pyg-team/pytorch_geometric/blob/ffb70bcf6147b8d5c5a00650e1d1f514771d8898/examples/hetero/hetero_link_pred.py
...
parser.add_argument(
    '--use_weighted_loss', action='store_true',
